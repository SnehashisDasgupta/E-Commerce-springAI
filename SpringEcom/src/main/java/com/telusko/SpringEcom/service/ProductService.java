...
public class ProductService {
    ...
    public String generateDescription(String name, String category, String description) {
        String descPrompt = String.format("""
                    Write a concise and professional product description for an e-commerce listing.
           
                    Product Name: %s
                    Product Category: %s
                    Description (Optional): %s
                
                    Keep it engaging and highlight its primary features and benefits. Keep it customer-friendly.
                    If description is given then make it more better and correct it grammatically.
                    Limit the description to 150 characters max.
